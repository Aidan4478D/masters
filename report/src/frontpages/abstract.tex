\begin{abstract}
    ...
    performance. The baseline YOLOv11s model achieved an mAP50 of 0.804 and an mAP50--95 
    of 0.615 on the validation set, while the final refined model improved to an 
    mAP50 of 0.857 and an mAP50--95 of 0.661 through targeted data refinement. On a 
    held-out test set, the final model reached an mAP50 of 0.772 and an mAP50--95 of
    0.607, while performance on a cross-camera benchmark of unseen locations dropped
    to an mAP50 of 0.658 and an mAP50--95 of 0.488, showing that generalization to new 
