\begin{abstract}
    Traffic-related air pollution remains a significant public health concern in 
    dense urban environments, but traditional monitoring infrastructure cannot 
    easily provide continuous, street-level measurements that distinguish between 
    different types of vehicles. This 
    ...
    6-class structure aligned with broad EPA MOVES vehicle categories. Several 
    ...
    performance. The baseline YOLOv11s model achieved a mAP50 of 0.804 and a mAP50--95 
    of 0.615 on the validation set, while the final refined model improved to a 
    mAP50 of 0.857 and a mAP50--95 of 0.661 through targeted data refinement. On a 
    held-out test set, the final model reached a mAP50 of 0.772 and a mAP50--95 of
    0.607, while performance on a cross-camera benchmark of unseen locations dropped
    to a mAP50 of 0.658 and a mAP50--95 of 0.488, showing that generalization to new 
    camera views remains a challenge. Comparison against New York City automated 
