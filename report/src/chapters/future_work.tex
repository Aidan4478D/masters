...
A natural next step is expanding dataset coverage and cross-camera generalization. 
...
would help prevent repeated counting of persistent vehicles between snapshots. A statistical calibration
