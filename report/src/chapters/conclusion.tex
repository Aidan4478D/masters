...
setting, with the baseline YOLOv11s model achieving an mAP50 of 0.804 and an mAP50--95 of 
0.615 on the validation set. After targeted refinement, the final selected YOLOv11s 
configuration reached an mAP50 of 0.857 and an mAP50--95 of 0.661 on the validation set, showing that careful 
...
better match for the limitations of 352$\times$240 traffic imagery, where many vehicles 
...
held-out test set, the final model achieved an overall mAP50 of 0.772 and an mAP50--95 of 
...
to an mAP50 of 0.658 and an mAP50--95 of 0.488, showing that transfer to new camera views 
