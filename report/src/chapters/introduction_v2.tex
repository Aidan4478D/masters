...
To tackle this problem, a vehicle-detection pipeline has been developed using publicly available
...
targeted data-centric refinement rather than broader tuning alone. The final model has been assessed
