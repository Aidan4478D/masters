...
and truck traffic accounts for 14\% of PM2.5 emitted by NYC activities
...
Obtaining this type of information continuously and at the street level remains difficult.
...
occlusion, glare, rain, and non-ideal viewing angles. Despite the low image quality, 
...
To tackle this problem, a vehicle-detection pipeline was developed using publicly available
...
low-resolution urban traffic scenes.
Rather than using a generic vehicle taxonomy, the detector is trained and evaluated with 
a class structure tailored to the EPA's MOtor Vehicle Emission Simulator (MOVES). This 
taxonomy balances what can be distinguished reliably in low-resolution imagery with what
remains useful for downstream emissions analysis
...
targeted data-centric refinement rather than broader tuning alone. The final model was assessed
